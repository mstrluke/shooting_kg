...
export default function AboutPage() {
  ...
  const { data: page, isLoading } = useQuery({ queryKey: ['page', 'about'], queryFn: () => getPageBySlug('about') });

  return (
    <>
      <PageHeader image={hero.image} title={hero.title || page?.title || 'О нас'} subtitle={hero.subtitle || "Федерация стрелкового спорта Кыргызской Республики"} />
